...
umain(int argc, char **argv)
{
  ...
  800044:	e8 3c 0c 00 00       	call   800c85 <sys_cputs>
}
...
libmain(int argc, char **argv)
{
  ...
  8000d0:	50                   	push   %eax
  8000d1:	68 8e 25 80 00       	push   $0x80258e
  8000d6:	e8 15 01 00 00       	call   8001f0 <cprintf>
	cprintf("before umain\n");
  8000db:	c7 04 24 ac 25 80 00 	movl   $0x8025ac,(%esp)
  ...
  8000f0:	e8 3e ff ff ff       	call   800033 <umain>
	cprintf("after umain\n");
  8000f5:	c7 04 24 ba 25 80 00 	movl   $0x8025ba,(%esp)
  ...
  80010c:	50                   	push   %eax
  80010d:	68 c7 25 80 00       	push   $0x8025c7
...
exit(void)
{
  ...
  800135:	68 f4 25 80 00       	push   $0x8025f4
  80013a:	50                   	push   %eax
  80013b:	68 e6 25 80 00       	push   $0x8025e6
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ce:	0f be 80 f9 25 80 00 	movsbl 0x8025f9(%eax),%eax
  8002d5:	50                   	push   %eax
...
0080031d <vprintfmt>:
{
  ...
  800465:	50                   	push   %eax
  800466:	68 11 26 80 00       	push   $0x802611
  80046b:	53                   	push   %ebx
  80046c:	56                   	push   %esi
  ...
  80048d:	b8 0a 26 80 00       	mov    $0x80260a,%eax
  ...
  800825:	bf 2d 27 80 00       	mov    $0x80272d,%edi
							putch(ch, putdat);
  ...
  800851:	bf 65 27 80 00       	mov    $0x802765,%edi
							putch(ch, putdat);
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80110d:	b8 08 30 80 00       	mov    $0x803008,%eax
...
008018e8 <fd2sockid>:
{
  ...
  801902:	8b 0d 24 30 80 00    	mov    0x803024,%ecx
...
00801918 <alloc_sockfd>:
{
  ...
  801952:	8b 15 24 30 80 00    	mov    0x803024,%edx
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801cfe:	00 00 00 
	stat->st_dev = &devpipe;
  801d01:	c7 83 88 00 00 00 40 	movl   $0x803040,0x88(%ebx)
  801d08:	30 80 00 
	return 0;
}
...
00801e9a <pipe>:
{
  ...
  801f5f:	a1 40 30 80 00       	mov    0x803040,%eax
...
0080210e <iscons>:
{
  ...
  80212a:	8b 15 5c 30 80 00    	mov    0x80305c,%edx
...
0080213a <opencons>:
{
  ...
  80216c:	8b 15 5c 30 80 00    	mov    0x80305c,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8021a1:	50                   	push   %eax
  8021a2:	68 e6 25 80 00       	push   $0x8025e6
  ...
  8021ac:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8021af:	8b 35 04 30 80 00    	mov    0x803004,%esi
  ...
  8021d6:	e8 c4 df ff ff       	call   80019f <vcprintf>
	cprintf("\n");
  8021db:	c7 04 24 aa 25 80 00 	movl   $0x8025aa,(%esp)
