...
libmain(int argc, char **argv)
{
  ...
  8000d0:	50                   	push   %eax
  8000d1:	68 6e 25 80 00       	push   $0x80256e
  8000d6:	e8 15 01 00 00       	call   8001f0 <cprintf>
	cprintf("before umain\n");
  8000db:	c7 04 24 8c 25 80 00 	movl   $0x80258c,(%esp)
  ...
  8000f0:	e8 3e ff ff ff       	call   800033 <umain>
	cprintf("after umain\n");
  8000f5:	c7 04 24 9a 25 80 00 	movl   $0x80259a,(%esp)
  ...
  80010c:	50                   	push   %eax
  80010d:	68 a7 25 80 00       	push   $0x8025a7
...
exit(void)
{
  ...
  800135:	68 d4 25 80 00       	push   $0x8025d4
  80013a:	50                   	push   %eax
  80013b:	68 c6 25 80 00       	push   $0x8025c6
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ce:	0f be 80 d9 25 80 00 	movsbl 0x8025d9(%eax),%eax
  8002d5:	50                   	push   %eax
...
0080031d <vprintfmt>:
{
  ...
  800465:	50                   	push   %eax
  800466:	68 f1 25 80 00       	push   $0x8025f1
  80046b:	53                   	push   %ebx
  80046c:	56                   	push   %esi
  ...
  80048d:	b8 ea 25 80 00       	mov    $0x8025ea,%eax
  ...
  800825:	bf 0d 27 80 00       	mov    $0x80270d,%edi
							putch(ch, putdat);
  ...
  800851:	bf 45 27 80 00       	mov    $0x802745,%edi
							putch(ch, putdat);
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8010ed:	b8 08 30 80 00       	mov    $0x803008,%eax
...
008018c8 <fd2sockid>:
{
  ...
  8018e2:	8b 0d 24 30 80 00    	mov    0x803024,%ecx
...
008018f8 <alloc_sockfd>:
{
  ...
  801932:	8b 15 24 30 80 00    	mov    0x803024,%edx
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801cde:	00 00 00 
	stat->st_dev = &devpipe;
  801ce1:	c7 83 88 00 00 00 40 	movl   $0x803040,0x88(%ebx)
  801ce8:	30 80 00 
	return 0;
}
...
00801e7a <pipe>:
{
  ...
  801f3f:	a1 40 30 80 00       	mov    0x803040,%eax
...
008020ee <iscons>:
{
  ...
  80210a:	8b 15 5c 30 80 00    	mov    0x80305c,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  802181:	50                   	push   %eax
  802182:	68 c6 25 80 00       	push   $0x8025c6
  ...
  80218c:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80218f:	8b 35 04 30 80 00    	mov    0x803004,%esi
  ...
  8021b6:	e8 e4 df ff ff       	call   80019f <vcprintf>
	cprintf("\n");
  8021bb:	c7 04 24 8a 25 80 00 	movl   $0x80258a,(%esp)
