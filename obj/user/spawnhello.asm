...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800147:	68 04 2c 80 00       	push   $0x802c04
  80014c:	50                   	push   %eax
  80014d:	68 d2 2b 80 00       	push   $0x802bd2
  ...
  80016e:	56                   	push   %esi
  80016f:	50                   	push   %eax
  800170:	68 e0 2b 80 00       	push   $0x802be0
  ...
  800181:	e8 56 00 00 00       	call   8001dc <vcprintf>
	cprintf("\n");
  800186:	c7 04 24 c6 2b 80 00 	movl   $0x802bc6,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80030b:	0f be 80 0b 2c 80 00 	movsbl 0x802c0b(%eax),%eax
  800312:	50                   	push   %eax
...
0080035a <vprintfmt>:
{
  ...
  8004a2:	50                   	push   %eax
  8004a3:	68 23 2c 80 00       	push   $0x802c23
  8004a8:	53                   	push   %ebx
  8004a9:	56                   	push   %esi
  ...
  8004ca:	b8 1c 2c 80 00       	mov    $0x802c1c,%eax
  ...
  800862:	bf 41 2d 80 00       	mov    $0x802d41,%edi
							putch(ch, putdat);
  ...
  80088e:	bf 79 2d 80 00       	mov    $0x802d79,%edi
							putch(ch, putdat);
...
spawn(const char *prog, const char **argv)
{
  ...
  801890:	68 d6 2b 80 00       	push   $0x802bd6
...
init_stack(envid_t child, const char **argv, uintptr_t *init_esp)
{
  ...
  801931:	68 d6 2b 80 00       	push   $0x802bd6
...
copy_shared_pages(envid_t child)
{
  ...
  801cc5:	68 d6 2b 80 00       	push   $0x802bd6
...
00801e0c <spawnl>:
{
  ...
  801e1a:	68 d6 2b 80 00       	push   $0x802bd6
