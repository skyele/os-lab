...
umain(int argc, char **argv)
{
  ...
  800068:	c3                   	ret    
		panic("spawn(hello) failed: %e", r);
  800069:	50                   	push   %eax
  80006a:	68 04 2c 80 00       	push   $0x802c04
  80006f:	6a 09                	push   $0x9
  800071:	68 1c 2c 80 00       	push   $0x802c1c
...
libmain(int argc, char **argv)
{
  ...
  8000ff:	50                   	push   %eax
  800100:	68 2e 2c 80 00       	push   $0x802c2e
  800105:	e8 76 01 00 00       	call   800280 <cprintf>
	cprintf("before umain\n");
  80010a:	c7 04 24 4c 2c 80 00 	movl   $0x802c4c,(%esp)
  ...
  80011f:	e8 0f ff ff ff       	call   800033 <umain>
	cprintf("after umain\n");
  800124:	c7 04 24 5a 2c 80 00 	movl   $0x802c5a,(%esp)
  ...
  80013b:	50                   	push   %eax
  80013c:	68 67 2c 80 00       	push   $0x802c67
...
exit(void)
{
  ...
  800164:	68 94 2c 80 00       	push   $0x802c94
  800169:	50                   	push   %eax
  80016a:	68 86 2c 80 00       	push   $0x802c86
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80019a:	68 c0 2c 80 00       	push   $0x802cc0
  80019f:	50                   	push   %eax
  8001a0:	68 86 2c 80 00       	push   $0x802c86
  ...
  8001c1:	56                   	push   %esi
  8001c2:	50                   	push   %eax
  8001c3:	68 9c 2c 80 00       	push   $0x802c9c
  ...
  8001d4:	e8 56 00 00 00       	call   80022f <vcprintf>
	cprintf("\n");
  8001d9:	c7 04 24 4a 2c 80 00 	movl   $0x802c4a,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80035e:	0f be 80 c7 2c 80 00 	movsbl 0x802cc7(%eax),%eax
  800365:	50                   	push   %eax
...
008003ad <vprintfmt>:
{
  ...
  8004f5:	50                   	push   %eax
  8004f6:	68 df 2c 80 00       	push   $0x802cdf
  8004fb:	53                   	push   %ebx
  8004fc:	56                   	push   %esi
  ...
  80051d:	b8 d8 2c 80 00       	mov    $0x802cd8,%eax
  ...
  8008b5:	bf fd 2d 80 00       	mov    $0x802dfd,%edi
							putch(ch, putdat);
  ...
  8008e1:	bf 35 2e 80 00       	mov    $0x802e35,%edi
							putch(ch, putdat);
...
spawn(const char *prog, const char **argv)
{
  ...
  801903:	68 8a 2c 80 00       	push   $0x802c8a
...
init_stack(envid_t child, const char **argv, uintptr_t *init_esp)
{
  ...
  8019a5:	68 8a 2c 80 00       	push   $0x802c8a
...
copy_shared_pages(envid_t child)
{
  ...
  801d39:	68 8a 2c 80 00       	push   $0x802c8a
...
00801e80 <spawnl>:
{
  ...
  801e8e:	68 8a 2c 80 00       	push   $0x802c8a
