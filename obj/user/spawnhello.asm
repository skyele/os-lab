...
umain(int argc, char **argv)
{
  ...
  800068:	c3                   	ret    
		panic("spawn(hello) failed: %e", r);
  800069:	50                   	push   %eax
  80006a:	68 c4 2b 80 00       	push   $0x802bc4
  80006f:	6a 09                	push   $0x9
  800071:	68 dc 2b 80 00       	push   $0x802bdc
...
libmain(int argc, char **argv)
{
  ...
  8000fd:	50                   	push   %eax
  8000fe:	68 ee 2b 80 00       	push   $0x802bee
  800103:	e8 76 01 00 00       	call   80027e <cprintf>
	cprintf("before umain\n");
  800108:	c7 04 24 0c 2c 80 00 	movl   $0x802c0c,(%esp)
  ...
  80011d:	e8 11 ff ff ff       	call   800033 <umain>
	cprintf("after umain\n");
  800122:	c7 04 24 1a 2c 80 00 	movl   $0x802c1a,(%esp)
  ...
  800139:	50                   	push   %eax
  80013a:	68 27 2c 80 00       	push   $0x802c27
...
exit(void)
{
  ...
  800162:	68 54 2c 80 00       	push   $0x802c54
  800167:	50                   	push   %eax
  800168:	68 46 2c 80 00       	push   $0x802c46
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800198:	68 80 2c 80 00       	push   $0x802c80
  80019d:	50                   	push   %eax
  80019e:	68 46 2c 80 00       	push   $0x802c46
  ...
  8001bf:	56                   	push   %esi
  8001c0:	50                   	push   %eax
  8001c1:	68 5c 2c 80 00       	push   $0x802c5c
  ...
  8001d2:	e8 56 00 00 00       	call   80022d <vcprintf>
	cprintf("\n");
  8001d7:	c7 04 24 0a 2c 80 00 	movl   $0x802c0a,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80035c:	0f be 80 87 2c 80 00 	movsbl 0x802c87(%eax),%eax
  800363:	50                   	push   %eax
...
008003ab <vprintfmt>:
{
  ...
  8004f3:	50                   	push   %eax
  8004f4:	68 9f 2c 80 00       	push   $0x802c9f
  8004f9:	53                   	push   %ebx
  8004fa:	56                   	push   %esi
  ...
  80051b:	b8 98 2c 80 00       	mov    $0x802c98,%eax
  ...
  8008b3:	bf bd 2d 80 00       	mov    $0x802dbd,%edi
							putch(ch, putdat);
  ...
  8008df:	bf f5 2d 80 00       	mov    $0x802df5,%edi
							putch(ch, putdat);
...
spawn(const char *prog, const char **argv)
{
  ...
  8018e1:	68 4a 2c 80 00       	push   $0x802c4a
...
init_stack(envid_t child, const char **argv, uintptr_t *init_esp)
{
  ...
  801982:	68 4a 2c 80 00       	push   $0x802c4a
...
copy_shared_pages(envid_t child)
{
  ...
  801d16:	68 4a 2c 80 00       	push   $0x802c4a
...
00801e5d <spawnl>:
{
  ...
  801e6b:	68 4a 2c 80 00       	push   $0x802c4a
