...
void ring0_call(void (*fun_ptr)(void)) {
  ...
  8000b9:	e8 e3 0e 00 00       	call   800fa1 <sys_map_kernel_page>
    if (t < 0) {
  ...
  800123:	50                   	push   %eax
  800124:	68 00 26 80 00       	push   $0x802600
  800129:	e8 31 01 00 00       	call   80025f <cprintf>
...
libmain(int argc, char **argv)
{
  ...
  800158:	e8 15 0c 00 00       	call   800d72 <sys_getenvid>
  ...
  80016d:	a3 4c 50 80 00       	mov    %eax,0x80504c
...
exit(void)
{
  ...
  80019c:	a1 4c 50 80 00       	mov    0x80504c,%eax
  8001a1:	8b 40 48             	mov    0x48(%eax),%eax
  8001a4:	68 44 26 80 00       	push   $0x802644
  8001a9:	50                   	push   %eax
  8001aa:	68 36 26 80 00       	push   $0x802636
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80033d:	0f be 80 49 26 80 00 	movsbl 0x802649(%eax),%eax
  800344:	50                   	push   %eax
...
0080038c <vprintfmt>:
{
  ...
  8003e6:	ff 24 85 20 28 80 00 	jmp    *0x802820(,%eax,4)
  ...
  8004b1:	8b 14 85 80 29 80 00 	mov    0x802980(,%eax,4),%edx
  8004b8:	85 d2                	test   %edx,%edx
  8004ba:	74 18                	je     8004d4 <vprintfmt+0x148>
				printfmt(putch, putdat, "%s", p);
  8004bc:	52                   	push   %edx
  8004bd:	68 9d 2a 80 00       	push   $0x802a9d
  8004c2:	53                   	push   %ebx
  8004c3:	56                   	push   %esi
  ...
  8004d4:	50                   	push   %eax
  8004d5:	68 61 26 80 00       	push   $0x802661
  8004da:	53                   	push   %ebx
  8004db:	56                   	push   %esi
  ...
  8004fc:	b8 5a 26 80 00       	mov    $0x80265a,%eax
  ...
  800894:	bf 7d 27 80 00       	mov    $0x80277d,%edi
							putch(ch, putdat);
  ...
  8008c0:	bf b5 27 80 00       	mov    $0x8027b5,%edi
							putch(ch, putdat);
...
sys_env_destroy(envid_t envid)
{
  ...
  800d61:	68 c8 29 80 00       	push   $0x8029c8
  800d66:	6a 43                	push   $0x43
  800d68:	68 e5 29 80 00       	push   $0x8029e5
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800de2:	68 c8 29 80 00       	push   $0x8029c8
  800de7:	6a 43                	push   $0x43
  800de9:	68 e5 29 80 00       	push   $0x8029e5
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800e24:	68 c8 29 80 00       	push   $0x8029c8
  800e29:	6a 43                	push   $0x43
  800e2b:	68 e5 29 80 00       	push   $0x8029e5
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e66:	68 c8 29 80 00       	push   $0x8029c8
  800e6b:	6a 43                	push   $0x43
  800e6d:	68 e5 29 80 00       	push   $0x8029e5
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ea8:	68 c8 29 80 00       	push   $0x8029c8
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800eea:	68 c8 29 80 00       	push   $0x8029c8
  800eef:	6a 43                	push   $0x43
  800ef1:	68 e5 29 80 00       	push   $0x8029e5
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800f2c:	68 c8 29 80 00       	push   $0x8029c8
  800f31:	6a 43                	push   $0x43
  800f33:	68 e5 29 80 00       	push   $0x8029e5
...
sys_ipc_recv(void *dstva)
{
  ...
  800f90:	68 c8 29 80 00       	push   $0x8029c8
  800f95:	6a 43                	push   $0x43
  800f97:	68 e5 29 80 00       	push   $0x8029e5
...
sys_clear_access_bit(envid_t envid, void *va)
{
  ...
  801074:	68 c8 29 80 00       	push   $0x8029c8
  801079:	6a 43                	push   $0x43
  80107b:	68 e5 29 80 00       	push   $0x8029e5
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801188:	8b 04 95 70 2a 80 00 	mov    0x802a70(,%edx,4),%eax
  ...
  801193:	a1 4c 50 80 00       	mov    0x80504c,%eax
  801198:	8b 40 48             	mov    0x48(%eax),%eax
  80119b:	83 ec 04             	sub    $0x4,%esp
  80119e:	51                   	push   %ecx
  80119f:	50                   	push   %eax
  8011a0:	68 f4 29 80 00       	push   $0x8029f4
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8013ec:	c3                   	ret    
		cprintf("[%08x] read %d -- bad mode\n", thisenv->env_id, fdnum);
  8013ed:	a1 4c 50 80 00       	mov    0x80504c,%eax
  8013f2:	8b 40 48             	mov    0x48(%eax),%eax
  8013f5:	83 ec 04             	sub    $0x4,%esp
  8013f8:	53                   	push   %ebx
  8013f9:	50                   	push   %eax
  8013fa:	68 35 2a 80 00       	push   $0x802a35
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8014b4:	a1 4c 50 80 00       	mov    0x80504c,%eax
  8014b9:	8b 40 48             	mov    0x48(%eax),%eax
  8014bc:	83 ec 04             	sub    $0x4,%esp
  8014bf:	53                   	push   %ebx
  8014c0:	50                   	push   %eax
  8014c1:	68 51 2a 80 00       	push   $0x802a51
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80155b:	c3                   	ret    
			thisenv->env_id, fdnum);
  80155c:	a1 4c 50 80 00       	mov    0x80504c,%eax
		cprintf("[%08x] ftruncate %d -- bad mode\n",
  801561:	8b 40 48             	mov    0x48(%eax),%eax
  801564:	83 ec 04             	sub    $0x4,%esp
  801567:	53                   	push   %ebx
  801568:	50                   	push   %eax
  801569:	68 14 2a 80 00       	push   $0x802a14
...
fsipc(unsigned type, void *dstva)
{
  ...
  80164b:	68 00 60 80 00       	push   $0x806000
  801650:	56                   	push   %esi
...
devfile_trunc(struct Fd *fd, off_t newsize)
{
  ...
  801690:	a3 00 60 80 00       	mov    %eax,0x806000
	fsipcbuf.set_size.req_size = newsize;
  801695:	8b 45 0c             	mov    0xc(%ebp),%eax
  801698:	a3 04 60 80 00       	mov    %eax,0x806004
...
008016ae <devfile_flush>:
{
  ...
  8016ba:	a3 00 60 80 00       	mov    %eax,0x806000
...
008016d0 <devfile_stat>:
{
  ...
  8016e0:	a3 00 60 80 00       	mov    %eax,0x806000
  ...
  8016fb:	68 00 60 80 00       	push   $0x806000
  801700:	53                   	push   %ebx
  801701:	e8 b8 f2 ff ff       	call   8009be <strcpy>
	st->st_size = fsipcbuf.statRet.ret_size;
  801706:	a1 80 60 80 00       	mov    0x806080,%eax
  80170b:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	st->st_isdir = fsipcbuf.statRet.ret_isdir;
  801711:	a1 84 60 80 00       	mov    0x806084,%eax
...
00801729 <devfile_write>:
{
  ...
  801739:	a3 00 60 80 00       	mov    %eax,0x806000
	fsipcbuf.write.req_n = n;
  80173e:	89 1d 04 60 80 00    	mov    %ebx,0x806004
	memcpy(fsipcbuf.write.req_buf, buf, n);
  801744:	53                   	push   %ebx
  801745:	ff 75 0c             	pushl  0xc(%ebp)
  801748:	68 08 60 80 00       	push   $0x806008
  ...
  801777:	c3                   	ret    
	assert(r <= n);
  801778:	68 84 2a 80 00       	push   $0x802a84
  80177d:	68 8b 2a 80 00       	push   $0x802a8b
  801782:	68 98 00 00 00       	push   $0x98
  801787:	68 a0 2a 80 00       	push   $0x802aa0
  80178c:	e8 6a 0a 00 00       	call   8021fb <_panic>
	assert(r <= PGSIZE);
  801791:	68 ab 2a 80 00       	push   $0x802aab
  801796:	68 8b 2a 80 00       	push   $0x802a8b
  80179b:	68 99 00 00 00       	push   $0x99
  8017a0:	68 a0 2a 80 00       	push   $0x802aa0
...
008017aa <devfile_read>:
{
  ...
  8017bd:	89 35 04 60 80 00    	mov    %esi,0x806004
  ...
  8017e6:	50                   	push   %eax
  8017e7:	68 00 60 80 00       	push   $0x806000
  ...
  801805:	68 8b 2a 80 00       	push   $0x802a8b
  80180a:	6a 7c                	push   $0x7c
  80180c:	68 a0 2a 80 00       	push   $0x802aa0
  801811:	e8 e5 09 00 00       	call   8021fb <_panic>
	assert(r <= PGSIZE);
  801816:	68 ab 2a 80 00       	push   $0x802aab
  80181b:	68 8b 2a 80 00       	push   $0x802a8b
  801820:	6a 7d                	push   $0x7d
  801822:	68 a0 2a 80 00       	push   $0x802aa0
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8018d7:	68 b7 2a 80 00       	push   $0x802ab7
...
nsipc(unsigned type)
{
  ...
  801af2:	68 00 70 80 00       	push   $0x807000
  801af7:	53                   	push   %ebx
...
nsipc_accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  801b35:	a3 00 70 80 00       	mov    %eax,0x807000
	nsipcbuf.accept.req_addrlen = *addrlen;
  801b3a:	8b 06                	mov    (%esi),%eax
  801b3c:	a3 04 70 80 00       	mov    %eax,0x807004
  ...
  801b5d:	ff 35 10 70 80 00    	pushl  0x807010
  801b63:	68 00 70 80 00       	push   $0x807000
  801b68:	ff 75 0c             	pushl  0xc(%ebp)
  801b6b:	e8 dc ef ff ff       	call   800b4c <memmove>
		*addrlen = ret->ret_addrlen;
  801b70:	a1 10 70 80 00       	mov    0x807010,%eax
...
nsipc_bind(int s, struct sockaddr *name, socklen_t namelen)
{
  ...
  801b89:	a3 00 70 80 00       	mov    %eax,0x807000
	memmove(&nsipcbuf.bind.req_name, name, namelen);
  801b8e:	53                   	push   %ebx
  801b8f:	ff 75 0c             	pushl  0xc(%ebp)
  801b92:	68 04 70 80 00       	push   $0x807004
  801b97:	e8 b0 ef ff ff       	call   800b4c <memmove>
	nsipcbuf.bind.req_namelen = namelen;
  801b9c:	89 1d 14 70 80 00    	mov    %ebx,0x807014
...
nsipc_shutdown(int s, int how)
{
  ...
  801bc2:	a3 04 70 80 00       	mov    %eax,0x807004
...
nsipc_connect(int s, const struct sockaddr *name, socklen_t namelen)
{
  ...
  801bfa:	a3 00 70 80 00       	mov    %eax,0x807000
	memmove(&nsipcbuf.connect.req_name, name, namelen);
  801bff:	53                   	push   %ebx
  801c00:	ff 75 0c             	pushl  0xc(%ebp)
  801c03:	68 04 70 80 00       	push   $0x807004
  801c08:	e8 3f ef ff ff       	call   800b4c <memmove>
	nsipcbuf.connect.req_namelen = namelen;
  801c0d:	89 1d 14 70 80 00    	mov    %ebx,0x807014
...
nsipc_listen(int s, int backlog)
{
  ...
  801c33:	a3 04 70 80 00       	mov    %eax,0x807004
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801c54:	89 35 04 70 80 00    	mov    %esi,0x807004
	nsipcbuf.recv.req_flags = flags;
  801c5a:	8b 45 14             	mov    0x14(%ebp),%eax
  801c5d:	a3 08 70 80 00       	mov    %eax,0x807008
  ...
  801c80:	50                   	push   %eax
  801c81:	68 00 70 80 00       	push   $0x807000
  ...
  801c99:	c3                   	ret    
		assert(r < 1600 && r <= len);
  801c9a:	68 c3 2a 80 00       	push   $0x802ac3
  801c9f:	68 8b 2a 80 00       	push   $0x802a8b
  801ca4:	6a 62                	push   $0x62
  801ca6:	68 d8 2a 80 00       	push   $0x802ad8
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801cd1:	68 0c 70 80 00       	push   $0x80700c
  801cd6:	e8 71 ee ff ff       	call   800b4c <memmove>
	nsipcbuf.send.req_size = size;
  801cdb:	89 1d 04 70 80 00    	mov    %ebx,0x807004
	nsipcbuf.send.req_flags = flags;
  801ce1:	8b 45 14             	mov    0x14(%ebp),%eax
  801ce4:	a3 08 70 80 00       	mov    %eax,0x807008
  ...
  801cf7:	c3                   	ret    
	assert(size < 1600);
  801cf8:	68 e4 2a 80 00       	push   $0x802ae4
  801cfd:	68 8b 2a 80 00       	push   $0x802a8b
  801d02:	6a 6d                	push   $0x6d
  801d04:	68 d8 2a 80 00       	push   $0x802ad8
...
nsipc_socket(int domain, int type, int protocol)
{
  ...
  801d27:	a3 08 70 80 00       	mov    %eax,0x807008
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801d50:	68 f0 2a 80 00       	push   $0x802af0
  801d55:	53                   	push   %ebx
...
00801db0 <_pipeisclosed>:
{
  ...
  801dbb:	89 d6                	mov    %edx,%esi
		n = thisenv->env_runs;
  801dbd:	a1 4c 50 80 00       	mov    0x80504c,%eax
  ...
  801dd4:	e8 83 05 00 00       	call   80235c <pageref>
		nn = thisenv->env_runs;
  801dd9:	8b 15 4c 50 80 00    	mov    0x80504c,%edx
  ...
  801df3:	50                   	push   %eax
  801df4:	53                   	push   %ebx
  801df5:	68 f7 2a 80 00       	push   $0x802af7
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  802092:	68 0f 2b 80 00       	push   $0x802b0f
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8021ff:	53                   	push   %ebx
	cprintf("%d: in %s\n", thisenv->env_id, __FUNCTION__);
  802200:	a1 4c 50 80 00       	mov    0x80504c,%eax
  802205:	8b 40 48             	mov    0x48(%eax),%eax
  802208:	83 ec 04             	sub    $0x4,%esp
  80220b:	68 40 2b 80 00       	push   $0x802b40
  802210:	50                   	push   %eax
  802211:	68 36 26 80 00       	push   $0x802636
  ...
  802232:	56                   	push   %esi
  802233:	50                   	push   %eax
  802234:	68 1c 2b 80 00       	push   $0x802b1c
  ...
  802245:	e8 c4 df ff ff       	call   80020e <vcprintf>
	cprintf("\n");
  80224a:	c7 04 24 5a 2b 80 00 	movl   $0x802b5a,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802296:	a1 4c 50 80 00       	mov    0x80504c,%eax
...
{	
  ...
  802304:	68 47 2b 80 00       	push   $0x802b47
  802309:	6a 46                	push   $0x46
  80230b:	68 5c 2b 80 00       	push   $0x802b5c
