...
umain(int argc, char **argv)
{
  ...
  80003f:	68 00 25 80 00       	push   $0x802500
  800044:	e8 17 01 00 00       	call   800160 <cprintf>
}
...
exit(void)
{
  ...
  8000a5:	68 34 25 80 00       	push   $0x802534
  8000aa:	50                   	push   %eax
  8000ab:	68 28 25 80 00       	push   $0x802528
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80023e:	0f be 80 39 25 80 00 	movsbl 0x802539(%eax),%eax
  800245:	50                   	push   %eax
...
0080028d <vprintfmt>:
{
  ...
  8002e7:	ff 24 85 20 27 80 00 	jmp    *0x802720(,%eax,4)
  ...
  8003b2:	8b 14 85 80 28 80 00 	mov    0x802880(,%eax,4),%edx
  8003b9:	85 d2                	test   %edx,%edx
  8003bb:	74 18                	je     8003d5 <vprintfmt+0x148>
				printfmt(putch, putdat, "%s", p);
  8003bd:	52                   	push   %edx
  8003be:	68 9d 29 80 00       	push   $0x80299d
  8003c3:	53                   	push   %ebx
  8003c4:	56                   	push   %esi
  ...
  8003d5:	50                   	push   %eax
  8003d6:	68 51 25 80 00       	push   $0x802551
  8003db:	53                   	push   %ebx
  8003dc:	56                   	push   %esi
  ...
  8003fd:	b8 4a 25 80 00       	mov    $0x80254a,%eax
  ...
  800795:	bf 6d 26 80 00       	mov    $0x80266d,%edi
							putch(ch, putdat);
  ...
  8007c1:	bf a5 26 80 00       	mov    $0x8026a5,%edi
							putch(ch, putdat);
...
sys_env_destroy(envid_t envid)
{
  ...
  800c62:	68 c8 28 80 00       	push   $0x8028c8
  800c67:	6a 43                	push   $0x43
  800c69:	68 e5 28 80 00       	push   $0x8028e5
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ce3:	68 c8 28 80 00       	push   $0x8028c8
  800ce8:	6a 43                	push   $0x43
  800cea:	68 e5 28 80 00       	push   $0x8028e5
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d25:	68 c8 28 80 00       	push   $0x8028c8
  800d2a:	6a 43                	push   $0x43
  800d2c:	68 e5 28 80 00       	push   $0x8028e5
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d67:	68 c8 28 80 00       	push   $0x8028c8
  800d6c:	6a 43                	push   $0x43
  800d6e:	68 e5 28 80 00       	push   $0x8028e5
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800da9:	68 c8 28 80 00       	push   $0x8028c8
  800dae:	6a 43                	push   $0x43
  800db0:	68 e5 28 80 00       	push   $0x8028e5
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800deb:	68 c8 28 80 00       	push   $0x8028c8
  800df0:	6a 43                	push   $0x43
  800df2:	68 e5 28 80 00       	push   $0x8028e5
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e2d:	68 c8 28 80 00       	push   $0x8028c8
  800e32:	6a 43                	push   $0x43
  800e34:	68 e5 28 80 00       	push   $0x8028e5
...
sys_ipc_recv(void *dstva)
{
  ...
  800e91:	68 c8 28 80 00       	push   $0x8028c8
  800e96:	6a 43                	push   $0x43
  800e98:	68 e5 28 80 00       	push   $0x8028e5
...
sys_clear_access_bit(envid_t envid, void *va)
{
  ...
  800f75:	68 c8 28 80 00       	push   $0x8028c8
  800f7a:	6a 43                	push   $0x43
  800f7c:	68 e5 28 80 00       	push   $0x8028e5
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80109f:	51                   	push   %ecx
  8010a0:	50                   	push   %eax
  8010a1:	68 f4 28 80 00       	push   $0x8028f4
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8012f9:	53                   	push   %ebx
  8012fa:	50                   	push   %eax
  8012fb:	68 35 29 80 00       	push   $0x802935
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8013c0:	53                   	push   %ebx
  8013c1:	50                   	push   %eax
  8013c2:	68 51 29 80 00       	push   $0x802951
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801468:	53                   	push   %ebx
  801469:	50                   	push   %eax
  80146a:	68 14 29 80 00       	push   $0x802914
...
0080162a <devfile_write>:
{
  ...
  801678:	c3                   	ret    
	assert(r <= n);
  801679:	68 84 29 80 00       	push   $0x802984
  80167e:	68 8b 29 80 00       	push   $0x80298b
  801683:	68 98 00 00 00       	push   $0x98
  801688:	68 a0 29 80 00       	push   $0x8029a0
  80168d:	e8 6a 0a 00 00       	call   8020fc <_panic>
	assert(r <= PGSIZE);
  801692:	68 ab 29 80 00       	push   $0x8029ab
  801697:	68 8b 29 80 00       	push   $0x80298b
  80169c:	68 99 00 00 00       	push   $0x99
  8016a1:	68 a0 29 80 00       	push   $0x8029a0
...
008016ab <devfile_read>:
{
  ...
  801700:	c3                   	ret    
	assert(r <= n);
  801701:	68 84 29 80 00       	push   $0x802984
  801706:	68 8b 29 80 00       	push   $0x80298b
  80170b:	6a 7c                	push   $0x7c
  80170d:	68 a0 29 80 00       	push   $0x8029a0
  801712:	e8 e5 09 00 00       	call   8020fc <_panic>
	assert(r <= PGSIZE);
  801717:	68 ab 29 80 00       	push   $0x8029ab
  80171c:	68 8b 29 80 00       	push   $0x80298b
  801721:	6a 7d                	push   $0x7d
  801723:	68 a0 29 80 00       	push   $0x8029a0
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8017d8:	68 b7 29 80 00       	push   $0x8029b7
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801b9a:	c3                   	ret    
		assert(r < 1600 && r <= len);
  801b9b:	68 c3 29 80 00       	push   $0x8029c3
  801ba0:	68 8b 29 80 00       	push   $0x80298b
  801ba5:	6a 62                	push   $0x62
  801ba7:	68 d8 29 80 00       	push   $0x8029d8
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801bf8:	c3                   	ret    
	assert(size < 1600);
  801bf9:	68 e4 29 80 00       	push   $0x8029e4
  801bfe:	68 8b 29 80 00       	push   $0x80298b
  801c03:	6a 6d                	push   $0x6d
  801c05:	68 d8 29 80 00       	push   $0x8029d8
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801c51:	68 f0 29 80 00       	push   $0x8029f0
  801c56:	53                   	push   %ebx
  ...
  801c6e:	00 00 00 
	stat->st_dev = &devpipe;
  801c71:	c7 83 88 00 00 00 3c 	movl   $0x80303c,0x88(%ebx)
  801c78:	30 80 00 
	return 0;
}
...
00801cb1 <_pipeisclosed>:
{
  ...
  801cf4:	50                   	push   %eax
  801cf5:	53                   	push   %ebx
  801cf6:	68 f7 29 80 00       	push   $0x8029f7
...
00801e0a <pipe>:
{
  ...
  801ecf:	a1 3c 30 80 00       	mov    0x80303c,%eax
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801f93:	68 0f 2a 80 00       	push   $0x802a0f
...
0080207e <iscons>:
{
  ...
  80209a:	8b 15 58 30 80 00    	mov    0x803058,%edx
...
008020aa <opencons>:
{
  ...
  8020dc:	8b 15 58 30 80 00    	mov    0x803058,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80210c:	68 40 2a 80 00       	push   $0x802a40
  802111:	50                   	push   %eax
  802112:	68 28 25 80 00       	push   $0x802528
  ...
  80211c:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80211f:	8b 35 00 30 80 00    	mov    0x803000,%esi
  ...
  802133:	56                   	push   %esi
  802134:	50                   	push   %eax
  802135:	68 1c 2a 80 00       	push   $0x802a1c
  ...
  802146:	e8 c4 df ff ff       	call   80010f <vcprintf>
	cprintf("\n");
  80214b:	c7 04 24 1c 25 80 00 	movl   $0x80251c,(%esp)
...
{	
  ...
  802205:	68 47 2a 80 00       	push   $0x802a47
  80220a:	6a 46                	push   $0x46
  80220c:	68 5c 2a 80 00       	push   $0x802a5c
