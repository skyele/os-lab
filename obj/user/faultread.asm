...
libmain(int argc, char **argv)
{
  ...
  8000d0:	50                   	push   %eax
  8000d1:	68 9e 25 80 00       	push   $0x80259e
  8000d6:	e8 15 01 00 00       	call   8001f0 <cprintf>
	cprintf("before umain\n");
  8000db:	c7 04 24 bc 25 80 00 	movl   $0x8025bc,(%esp)
  ...
  8000f0:	e8 3e ff ff ff       	call   800033 <umain>
	cprintf("after umain\n");
  8000f5:	c7 04 24 ca 25 80 00 	movl   $0x8025ca,(%esp)
  ...
  80010c:	50                   	push   %eax
  80010d:	68 d7 25 80 00       	push   $0x8025d7
...
exit(void)
{
  ...
  800135:	68 04 26 80 00       	push   $0x802604
  80013a:	50                   	push   %eax
  80013b:	68 f6 25 80 00       	push   $0x8025f6
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ce:	0f be 80 09 26 80 00 	movsbl 0x802609(%eax),%eax
  8002d5:	50                   	push   %eax
...
0080031d <vprintfmt>:
{
  ...
  800465:	50                   	push   %eax
  800466:	68 21 26 80 00       	push   $0x802621
  80046b:	53                   	push   %ebx
  80046c:	56                   	push   %esi
  ...
  80048d:	b8 1a 26 80 00       	mov    $0x80261a,%eax
  ...
  800825:	bf 3d 27 80 00       	mov    $0x80273d,%edi
							putch(ch, putdat);
  ...
  800851:	bf 75 27 80 00       	mov    $0x802775,%edi
							putch(ch, putdat);
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8021a1:	50                   	push   %eax
  8021a2:	68 f6 25 80 00       	push   $0x8025f6
  ...
  8021d6:	e8 c4 df ff ff       	call   80019f <vcprintf>
	cprintf("\n");
  8021db:	c7 04 24 9c 25 80 00 	movl   $0x80259c,(%esp)
