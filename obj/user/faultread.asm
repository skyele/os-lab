	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800268:	0f be 80 e8 11 80 00 	movsbl 0x8011e8(%eax),%eax
  80026f:	50                   	push   %eax
...
008002b7 <vprintfmt>:
{
  ...
  800311:	ff 24 85 c0 13 80 00 	jmp    *0x8013c0(,%eax,4)
  ...
  8003dc:	8b 14 85 20 15 80 00 	mov    0x801520(,%eax,4),%edx
  8003e3:	85 d2                	test   %edx,%edx
  8003e5:	74 18                	je     8003ff <vprintfmt+0x148>
				printfmt(putch, putdat, "%s", p);
  8003e7:	52                   	push   %edx
  8003e8:	68 09 12 80 00       	push   $0x801209
  8003ed:	53                   	push   %ebx
  8003ee:	56                   	push   %esi
  ...
  8003ff:	50                   	push   %eax
  800400:	68 00 12 80 00       	push   $0x801200
  800405:	53                   	push   %ebx
  800406:	56                   	push   %esi
  ...
  800427:	b8 f9 11 80 00       	mov    $0x8011f9,%eax
  ...
  8007bf:	bf 21 13 80 00       	mov    $0x801321,%edi
							putch(ch, putdat);
  ...
  8007eb:	bf 59 13 80 00       	mov    $0x801359,%edi
							putch(ch, putdat);
...
sys_env_destroy(envid_t envid)
{
  ...
  800c8c:	68 60 15 80 00       	push   $0x801560
  800c91:	6a 43                	push   $0x43
  800c93:	68 7d 15 80 00       	push   $0x80157d
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d0d:	68 60 15 80 00       	push   $0x801560
  800d12:	6a 43                	push   $0x43
  800d14:	68 7d 15 80 00       	push   $0x80157d
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d4f:	68 60 15 80 00       	push   $0x801560
  800d54:	6a 43                	push   $0x43
  800d56:	68 7d 15 80 00       	push   $0x80157d
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d91:	68 60 15 80 00       	push   $0x801560
  800d96:	6a 43                	push   $0x43
  800d98:	68 7d 15 80 00       	push   $0x80157d
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dd3:	68 60 15 80 00       	push   $0x801560
  800dd8:	6a 43                	push   $0x43
  800dda:	68 7d 15 80 00       	push   $0x80157d
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800e15:	68 60 15 80 00       	push   $0x801560
  800e1a:	6a 43                	push   $0x43
  800e1c:	68 7d 15 80 00       	push   $0x80157d
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e57:	68 60 15 80 00       	push   $0x801560
  800e5c:	6a 43                	push   $0x43
  800e5e:	68 7d 15 80 00       	push   $0x80157d
...
sys_ipc_recv(void *dstva)
{
  ...
  800ebb:	68 60 15 80 00       	push   $0x801560
  800ec0:	6a 43                	push   $0x43
  800ec2:	68 7d 15 80 00       	push   $0x80157d
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f1d:	68 bc 15 80 00       	push   $0x8015bc
  800f22:	50                   	push   %eax
  800f23:	68 8b 15 80 00       	push   $0x80158b
  ...
  800f44:	56                   	push   %esi
  800f45:	50                   	push   %eax
  800f46:	68 98 15 80 00       	push   $0x801598
  ...
  800f57:	e8 dd f1 ff ff       	call   800139 <vcprintf>
	cprintf("\n");
  800f5c:	c7 04 24 dc 11 80 00 	movl   $0x8011dc,(%esp)
