...
umain(int argc, char **argv)
{
  ...
  800044:	e8 a9 01 00 00       	call   8001f2 <cprintf>
}
...
libmain(int argc, char **argv)
{
  ...
  8000d2:	50                   	push   %eax
  8000d3:	68 9e 25 80 00       	push   $0x80259e
  8000d8:	e8 15 01 00 00       	call   8001f2 <cprintf>
	cprintf("before umain\n");
  8000dd:	c7 04 24 bc 25 80 00 	movl   $0x8025bc,(%esp)
  ...
  8000f2:	e8 3c ff ff ff       	call   800033 <umain>
	cprintf("after umain\n");
  8000f7:	c7 04 24 ca 25 80 00 	movl   $0x8025ca,(%esp)
  ...
  80010e:	50                   	push   %eax
  80010f:	68 d7 25 80 00       	push   $0x8025d7
...
exit(void)
{
  ...
  800137:	68 04 26 80 00       	push   $0x802604
  80013c:	50                   	push   %eax
  80013d:	68 f6 25 80 00       	push   $0x8025f6
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002d0:	0f be 80 09 26 80 00 	movsbl 0x802609(%eax),%eax
  8002d7:	50                   	push   %eax
...
0080031f <vprintfmt>:
{
  ...
  800467:	50                   	push   %eax
  800468:	68 21 26 80 00       	push   $0x802621
  80046d:	53                   	push   %ebx
  80046e:	56                   	push   %esi
  ...
  80048f:	b8 1a 26 80 00       	mov    $0x80261a,%eax
  ...
  800827:	bf 3d 27 80 00       	mov    $0x80273d,%edi
							putch(ch, putdat);
  ...
  800853:	bf 75 27 80 00       	mov    $0x802775,%edi
							putch(ch, putdat);
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80110f:	b8 04 30 80 00       	mov    $0x803004,%eax
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801d00:	00 00 00 
	stat->st_dev = &devpipe;
  801d03:	c7 83 88 00 00 00 3c 	movl   $0x80303c,0x88(%ebx)
  801d0a:	30 80 00 
	return 0;
}
...
00801e9c <pipe>:
{
  ...
  801f61:	a1 3c 30 80 00       	mov    0x80303c,%eax
...
0080213c <opencons>:
{
  ...
  80216e:	8b 15 58 30 80 00    	mov    0x803058,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8021a3:	50                   	push   %eax
  8021a4:	68 f6 25 80 00       	push   $0x8025f6
  ...
  8021ae:	8d 5d 14             	lea    0x14(%ebp),%ebx
	...
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8021b1:	8b 35 00 30 80 00    	mov    0x803000,%esi
  ...
  8021d8:	e8 c4 df ff ff       	call   8001a1 <vcprintf>
	cprintf("\n");
  8021dd:	c7 04 24 9c 25 80 00 	movl   $0x80259c,(%esp)
