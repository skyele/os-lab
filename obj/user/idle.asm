...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 20 80 00 c0 	movl   $0x8011c0,0x802000
  800040:	11 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 46 01 00 00       	call   80018e <sys_yield>
...
sys_env_destroy(envid_t envid)
{
  ...
  80015e:	68 cf 11 80 00       	push   $0x8011cf
  800163:	6a 43                	push   $0x43
  800165:	68 ec 11 80 00       	push   $0x8011ec
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001df:	68 cf 11 80 00       	push   $0x8011cf
  8001e4:	6a 43                	push   $0x43
  8001e6:	68 ec 11 80 00       	push   $0x8011ec
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800221:	68 cf 11 80 00       	push   $0x8011cf
  800226:	6a 43                	push   $0x43
  800228:	68 ec 11 80 00       	push   $0x8011ec
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800263:	68 cf 11 80 00       	push   $0x8011cf
  800268:	6a 43                	push   $0x43
  80026a:	68 ec 11 80 00       	push   $0x8011ec
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a5:	68 cf 11 80 00       	push   $0x8011cf
  8002aa:	6a 43                	push   $0x43
  8002ac:	68 ec 11 80 00       	push   $0x8011ec
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e7:	68 cf 11 80 00       	push   $0x8011cf
  8002ec:	6a 43                	push   $0x43
  8002ee:	68 ec 11 80 00       	push   $0x8011ec
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800329:	68 cf 11 80 00       	push   $0x8011cf
  80032e:	6a 43                	push   $0x43
  800330:	68 ec 11 80 00       	push   $0x8011ec
...
sys_ipc_recv(void *dstva)
{
  ...
  80038d:	68 cf 11 80 00       	push   $0x8011cf
  800392:	6a 43                	push   $0x43
  800394:	68 ec 11 80 00       	push   $0x8011ec
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8003ef:	68 2c 12 80 00       	push   $0x80122c
  8003f4:	50                   	push   %eax
  8003f5:	68 fa 11 80 00       	push   $0x8011fa
  ...
  800416:	56                   	push   %esi
  800417:	50                   	push   %eax
  800418:	68 08 12 80 00       	push   $0x801208
  ...
  800429:	e8 56 00 00 00       	call   800484 <vcprintf>
	cprintf("\n");
  80042e:	c7 04 24 03 12 80 00 	movl   $0x801203,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8005b3:	0f be 80 33 12 80 00 	movsbl 0x801233(%eax),%eax
  8005ba:	50                   	push   %eax
...
00800602 <vprintfmt>:
{
  ...
  80065c:	ff 24 85 20 14 80 00 	jmp    *0x801420(,%eax,4)
  ...
  800727:	8b 14 85 80 15 80 00 	mov    0x801580(,%eax,4),%edx
  80072e:	85 d2                	test   %edx,%edx
  800730:	74 18                	je     80074a <vprintfmt+0x148>
				printfmt(putch, putdat, "%s", p);
  800732:	52                   	push   %edx
  800733:	68 54 12 80 00       	push   $0x801254
  800738:	53                   	push   %ebx
  800739:	56                   	push   %esi
  ...
  80074a:	50                   	push   %eax
  80074b:	68 4b 12 80 00       	push   $0x80124b
  800750:	53                   	push   %ebx
  800751:	56                   	push   %esi
  ...
  800772:	b8 44 12 80 00       	mov    $0x801244,%eax
  ...
  800b0a:	bf 6d 13 80 00       	mov    $0x80136d,%edi
							putch(ch, putdat);
  ...
  800b36:	bf a5 13 80 00       	mov    $0x8013a5,%edi
							putch(ch, putdat);
