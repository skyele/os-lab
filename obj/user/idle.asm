...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 80 	movl   $0x802580,0x803000
  800040:	25 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 d8 0c 00 00       	call   800d20 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  8000ce:	50                   	push   %eax
  8000cf:	68 85 25 80 00       	push   $0x802585
  8000d4:	e8 15 01 00 00       	call   8001ee <cprintf>
	cprintf("before umain\n");
  8000d9:	c7 04 24 a3 25 80 00 	movl   $0x8025a3,(%esp)
  ...
  8000ee:	e8 40 ff ff ff       	call   800033 <umain>
	cprintf("after umain\n");
  8000f3:	c7 04 24 b1 25 80 00 	movl   $0x8025b1,(%esp)
  ...
  80010a:	50                   	push   %eax
  80010b:	68 be 25 80 00       	push   $0x8025be
...
exit(void)
{
  ...
  800133:	68 e8 25 80 00       	push   $0x8025e8
  800138:	50                   	push   %eax
  800139:	68 dd 25 80 00       	push   $0x8025dd
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002cc:	0f be 80 ed 25 80 00 	movsbl 0x8025ed(%eax),%eax
  8002d3:	50                   	push   %eax
...
0080031b <vprintfmt>:
{
  ...
  800463:	50                   	push   %eax
  800464:	68 05 26 80 00       	push   $0x802605
  800469:	53                   	push   %ebx
  80046a:	56                   	push   %esi
  ...
  80048b:	b8 fe 25 80 00       	mov    $0x8025fe,%eax
  ...
  800823:	bf 21 27 80 00       	mov    $0x802721,%edi
							putch(ch, putdat);
  ...
  80084f:	bf 59 27 80 00       	mov    $0x802759,%edi
							putch(ch, putdat);
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80219f:	50                   	push   %eax
  8021a0:	68 dd 25 80 00       	push   $0x8025dd
  ...
  8021d4:	e8 c4 df ff ff       	call   80019d <vcprintf>
	cprintf("\n");
  8021d9:	c7 04 24 a1 25 80 00 	movl   $0x8025a1,(%esp)
