...
libmain(int argc, char **argv)
{
  ...
  8000d2:	50                   	push   %eax
  8000d3:	68 a7 25 80 00       	push   $0x8025a7
  8000d8:	e8 15 01 00 00       	call   8001f2 <cprintf>
	cprintf("before umain\n");
  8000dd:	c7 04 24 c5 25 80 00 	movl   $0x8025c5,(%esp)
  ...
  8000f2:	e8 3c ff ff ff       	call   800033 <umain>
	cprintf("after umain\n");
  8000f7:	c7 04 24 d3 25 80 00 	movl   $0x8025d3,(%esp)
  ...
  80010e:	50                   	push   %eax
  80010f:	68 e0 25 80 00       	push   $0x8025e0
...
exit(void)
{
  ...
  800137:	68 0c 26 80 00       	push   $0x80260c
  80013c:	50                   	push   %eax
  80013d:	68 ff 25 80 00       	push   $0x8025ff
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002d0:	0f be 80 11 26 80 00 	movsbl 0x802611(%eax),%eax
  8002d7:	50                   	push   %eax
...
0080031f <vprintfmt>:
{
  ...
  800467:	50                   	push   %eax
  800468:	68 29 26 80 00       	push   $0x802629
  80046d:	53                   	push   %ebx
  80046e:	56                   	push   %esi
  ...
  80048f:	b8 22 26 80 00       	mov    $0x802622,%eax
  ...
  800827:	bf 45 27 80 00       	mov    $0x802745,%edi
							putch(ch, putdat);
  ...
  800853:	bf 7d 27 80 00       	mov    $0x80277d,%edi
							putch(ch, putdat);
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8021a3:	50                   	push   %eax
  8021a4:	68 ff 25 80 00       	push   $0x8025ff
  ...
  8021d8:	e8 c4 df ff ff       	call   8001a1 <vcprintf>
	cprintf("\n");
  8021dd:	c7 04 24 c3 25 80 00 	movl   $0x8025c3,(%esp)
