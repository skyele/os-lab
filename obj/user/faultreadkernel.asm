...
libmain(int argc, char **argv)
{
  ...
  8000d0:	50                   	push   %eax
  8000d1:	68 87 25 80 00       	push   $0x802587
  8000d6:	e8 15 01 00 00       	call   8001f0 <cprintf>
	cprintf("before umain\n");
  8000db:	c7 04 24 a5 25 80 00 	movl   $0x8025a5,(%esp)
  ...
  8000f0:	e8 3e ff ff ff       	call   800033 <umain>
	cprintf("after umain\n");
  8000f5:	c7 04 24 b3 25 80 00 	movl   $0x8025b3,(%esp)
  ...
  80010c:	50                   	push   %eax
  80010d:	68 c0 25 80 00       	push   $0x8025c0
...
exit(void)
{
  ...
  800135:	68 ec 25 80 00       	push   $0x8025ec
  80013a:	50                   	push   %eax
  80013b:	68 df 25 80 00       	push   $0x8025df
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ce:	0f be 80 f1 25 80 00 	movsbl 0x8025f1(%eax),%eax
  8002d5:	50                   	push   %eax
...
0080031d <vprintfmt>:
{
  ...
  800465:	50                   	push   %eax
  800466:	68 09 26 80 00       	push   $0x802609
  80046b:	53                   	push   %ebx
  80046c:	56                   	push   %esi
  ...
  80048d:	b8 02 26 80 00       	mov    $0x802602,%eax
  ...
  800825:	bf 25 27 80 00       	mov    $0x802725,%edi
							putch(ch, putdat);
  ...
  800851:	bf 5d 27 80 00       	mov    $0x80275d,%edi
							putch(ch, putdat);
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  802181:	50                   	push   %eax
  802182:	68 df 25 80 00       	push   $0x8025df
  ...
  8021b6:	e8 e4 df ff ff       	call   80019f <vcprintf>
	cprintf("\n");
  8021bb:	c7 04 24 a3 25 80 00 	movl   $0x8025a3,(%esp)
