...
exit(void)
{
  ...
  8000a5:	68 3c 25 80 00       	push   $0x80253c
  8000aa:	50                   	push   %eax
  8000ab:	68 31 25 80 00       	push   $0x802531
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80023e:	0f be 80 41 25 80 00 	movsbl 0x802541(%eax),%eax
  800245:	50                   	push   %eax
...
0080028d <vprintfmt>:
{
  ...
  8003d5:	50                   	push   %eax
  8003d6:	68 59 25 80 00       	push   $0x802559
  8003db:	53                   	push   %ebx
  8003dc:	56                   	push   %esi
  ...
  8003fd:	b8 52 25 80 00       	mov    $0x802552,%eax
  ...
  800795:	bf 75 26 80 00       	mov    $0x802675,%edi
							putch(ch, putdat);
  ...
  8007c1:	bf ad 26 80 00       	mov    $0x8026ad,%edi
							putch(ch, putdat);
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  802111:	50                   	push   %eax
  802112:	68 31 25 80 00       	push   $0x802531
  ...
  802146:	e8 c4 df ff ff       	call   80010f <vcprintf>
	cprintf("\n");
  80214b:	c7 04 24 5a 2a 80 00 	movl   $0x802a5a,(%esp)
