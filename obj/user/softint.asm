	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800265:	0f be 80 17 25 80 00 	movsbl 0x802517(%eax),%eax
  80026c:	50                   	push   %eax
...
008002b4 <vprintfmt>:
{
  ...
  8003fc:	50                   	push   %eax
  8003fd:	68 2f 25 80 00       	push   $0x80252f
  800402:	53                   	push   %ebx
  800403:	56                   	push   %esi
  ...
  800424:	b8 28 25 80 00       	mov    $0x802528,%eax
  ...
  8007bc:	bf 4d 26 80 00       	mov    $0x80264d,%edi
							putch(ch, putdat);
  ...
  8007e8:	bf 85 26 80 00       	mov    $0x802685,%edi
							putch(ch, putdat);
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80214d:	e8 e4 df ff ff       	call   800136 <vcprintf>
	cprintf("\n");
  802152:	c7 04 24 0b 25 80 00 	movl   $0x80250b,(%esp)
