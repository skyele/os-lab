...
umain(int argc, char **argv)
{
  ...
  800040:	e8 eb 0b 00 00       	call   800c30 <sys_cputs>
}
...
libmain(int argc, char **argv)
{
  ...
  8000c4:	68 00 25 80 00       	push   $0x802500
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800279:	0f be 80 24 25 80 00 	movsbl 0x802524(%eax),%eax
  800280:	50                   	push   %eax
...
008002c8 <vprintfmt>:
{
  ...
  800410:	50                   	push   %eax
  800411:	68 3c 25 80 00       	push   $0x80253c
  800416:	53                   	push   %ebx
  800417:	56                   	push   %esi
  ...
  800438:	b8 35 25 80 00       	mov    $0x802535,%eax
  ...
  8007d0:	bf 59 26 80 00       	mov    $0x802659,%edi
							putch(ch, putdat);
  ...
  8007fc:	bf 91 26 80 00       	mov    $0x802691,%edi
							putch(ch, putdat);
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  802161:	e8 e4 df ff ff       	call   80014a <vcprintf>
	cprintf("\n");
  802166:	c7 04 24 18 25 80 00 	movl   $0x802518,(%esp)
