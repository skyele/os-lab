...
umain(int argc, char **argv)
{
  ...
  800040:	e8 ac 0b 00 00       	call   800bf1 <sys_cputs>
}
...
exit(void)
{
  ...
  8000a1:	68 18 25 80 00       	push   $0x802518
  8000a6:	50                   	push   %eax
  8000a7:	68 0a 25 80 00       	push   $0x80250a
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80023a:	0f be 80 1d 25 80 00 	movsbl 0x80251d(%eax),%eax
  800241:	50                   	push   %eax
...
00800289 <vprintfmt>:
{
  ...
  8003d1:	50                   	push   %eax
  8003d2:	68 35 25 80 00       	push   $0x802535
  8003d7:	53                   	push   %ebx
  8003d8:	56                   	push   %esi
  ...
  8003f9:	b8 2e 25 80 00       	mov    $0x80252e,%eax
  ...
  800791:	bf 51 26 80 00       	mov    $0x802651,%edi
							putch(ch, putdat);
  ...
  8007bd:	bf 89 26 80 00       	mov    $0x802689,%edi
							putch(ch, putdat);
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80210d:	50                   	push   %eax
  80210e:	68 0a 25 80 00       	push   $0x80250a
