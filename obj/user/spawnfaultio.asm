...
umain(int argc, char **argv)
{
  ...
  800068:	c3                   	ret    
		panic("spawn(faultio) failed: %e", r);
  800069:	50                   	push   %eax
  80006a:	68 46 25 80 00       	push   $0x802546
  80006f:	6a 09                	push   $0x9
  800071:	68 60 25 80 00       	push   $0x802560
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800132:	68 b0 25 80 00       	push   $0x8025b0
  800137:	50                   	push   %eax
  800138:	68 7e 25 80 00       	push   $0x80257e
  ...
  800159:	56                   	push   %esi
  80015a:	50                   	push   %eax
  80015b:	68 8c 25 80 00       	push   $0x80258c
  ...
  80016c:	e8 56 00 00 00       	call   8001c7 <vcprintf>
	cprintf("\n");
  800171:	c7 04 24 26 2b 80 00 	movl   $0x802b26,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002f6:	0f be 80 b7 25 80 00 	movsbl 0x8025b7(%eax),%eax
  8002fd:	50                   	push   %eax
...
00800345 <vprintfmt>:
{
  ...
  80039f:	ff 24 85 a0 27 80 00 	jmp    *0x8027a0(,%eax,4)
  ...
  80046a:	8b 14 85 00 29 80 00 	mov    0x802900(,%eax,4),%edx
  800471:	85 d2                	test   %edx,%edx
  800473:	74 18                	je     80048d <vprintfmt+0x148>
				printfmt(putch, putdat, "%s", p);
  800475:	52                   	push   %edx
  800476:	68 97 29 80 00       	push   $0x802997
  80047b:	53                   	push   %ebx
  80047c:	56                   	push   %esi
  ...
  80048d:	50                   	push   %eax
  80048e:	68 cf 25 80 00       	push   $0x8025cf
  800493:	53                   	push   %ebx
  800494:	56                   	push   %esi
  ...
  8004b5:	b8 c8 25 80 00       	mov    $0x8025c8,%eax
  ...
  80084d:	bf ed 26 80 00       	mov    $0x8026ed,%edi
							putch(ch, putdat);
  ...
  800879:	bf 25 27 80 00       	mov    $0x802725,%edi
							putch(ch, putdat);
...
sys_env_destroy(envid_t envid)
{
  ...
  800d1a:	68 40 29 80 00       	push   $0x802940
  800d1f:	6a 43                	push   $0x43
  800d21:	68 5d 29 80 00       	push   $0x80295d
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d9b:	68 40 29 80 00       	push   $0x802940
  800da0:	6a 43                	push   $0x43
  800da2:	68 5d 29 80 00       	push   $0x80295d
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800ddd:	68 40 29 80 00       	push   $0x802940
  800de2:	6a 43                	push   $0x43
  800de4:	68 5d 29 80 00       	push   $0x80295d
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e1f:	68 40 29 80 00       	push   $0x802940
  800e24:	6a 43                	push   $0x43
  800e26:	68 5d 29 80 00       	push   $0x80295d
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e61:	68 40 29 80 00       	push   $0x802940
  800e66:	6a 43                	push   $0x43
  800e68:	68 5d 29 80 00       	push   $0x80295d
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800ea3:	68 40 29 80 00       	push   $0x802940
  800ea8:	6a 43                	push   $0x43
  800eaa:	68 5d 29 80 00       	push   $0x80295d
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ee5:	68 40 29 80 00       	push   $0x802940
  800eea:	6a 43                	push   $0x43
  800eec:	68 5d 29 80 00       	push   $0x80295d
...
sys_ipc_recv(void *dstva)
{
  ...
  800f49:	68 40 29 80 00       	push   $0x802940
  800f4e:	6a 43                	push   $0x43
  800f50:	68 5d 29 80 00       	push   $0x80295d
...
sys_exofork(void)
{
  ...
  80105e:	68 6b 29 80 00       	push   $0x80296b
  ...
  8011d4:	e9 4f 01 00 00       	jmp    801328 <spawn+0x38d>
	assert(string_store == (char*)UTEMP + PGSIZE);
  8011d9:	68 f4 29 80 00       	push   $0x8029f4
  8011de:	68 85 29 80 00       	push   $0x802985
  8011e3:	68 f2 00 00 00       	push   $0xf2
  8011e8:	68 9a 29 80 00       	push   $0x80299a
  ...
  8012fe:	e9 30 01 00 00       	jmp    801433 <spawn+0x498>
				panic("spawn: sys_page_map data: %e", r);
  801303:	50                   	push   %eax
  801304:	68 a6 29 80 00       	push   $0x8029a6
  801309:	68 25 01 00 00       	push   $0x125
  80130e:	68 9a 29 80 00       	push   $0x80299a
  ...
  8013fd:	50                   	push   %eax
  8013fe:	68 c3 29 80 00       	push   $0x8029c3
  801403:	68 86 00 00 00       	push   $0x86
  801408:	68 9a 29 80 00       	push   $0x80299a
  80140d:	e8 10 ed ff ff       	call   800122 <_panic>
		panic("sys_env_set_status: %e", r);
  801412:	50                   	push   %eax
  801413:	68 dd 29 80 00       	push   $0x8029dd
  801418:	68 89 00 00 00       	push   $0x89
  80141d:	68 9a 29 80 00       	push   $0x80299a
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8015cc:	ba 9c 2a 80 00       	mov    $0x802a9c,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  8015ee:	51                   	push   %ecx
  8015ef:	50                   	push   %eax
  8015f0:	68 1c 2a 80 00       	push   $0x802a1c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801848:	53                   	push   %ebx
  801849:	50                   	push   %eax
  80184a:	68 60 2a 80 00       	push   $0x802a60
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80190f:	53                   	push   %ebx
  801910:	50                   	push   %eax
  801911:	68 7c 2a 80 00       	push   $0x802a7c
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8019b7:	53                   	push   %ebx
  8019b8:	50                   	push   %eax
  8019b9:	68 3c 2a 80 00       	push   $0x802a3c
...
00801b79 <devfile_write>:
{
  ...
  801b7f:	68 ac 2a 80 00       	push   $0x802aac
  801b84:	68 90 00 00 00       	push   $0x90
  801b89:	68 ca 2a 80 00       	push   $0x802aca
...
00801b93 <devfile_read>:
{
  ...
  801be8:	c3                   	ret    
	assert(r <= n);
  801be9:	68 d5 2a 80 00       	push   $0x802ad5
  801bee:	68 85 29 80 00       	push   $0x802985
  801bf3:	6a 7c                	push   $0x7c
  801bf5:	68 ca 2a 80 00       	push   $0x802aca
  801bfa:	e8 23 e5 ff ff       	call   800122 <_panic>
	assert(r <= PGSIZE);
  801bff:	68 dc 2a 80 00       	push   $0x802adc
  801c04:	68 85 29 80 00       	push   $0x802985
  801c09:	6a 7d                	push   $0x7d
  801c0b:	68 ca 2a 80 00       	push   $0x802aca
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801cd2:	68 e8 2a 80 00       	push   $0x802ae8
  801cd7:	53                   	push   %ebx
...
00801d32 <_pipeisclosed>:
{
  ...
  801d75:	50                   	push   %eax
  801d76:	53                   	push   %ebx
  801d77:	68 ef 2a 80 00       	push   $0x802aef
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  802014:	68 07 2b 80 00       	push   $0x802b07
...
{	
  ...
  802225:	68 13 2b 80 00       	push   $0x802b13
  80222a:	6a 49                	push   $0x49
  80222c:	68 28 2b 80 00       	push   $0x802b28
