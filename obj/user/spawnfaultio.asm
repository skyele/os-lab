...
umain(int argc, char **argv)
{
  ...
  800068:	c3                   	ret    
		panic("spawn(faultio) failed: %e", r);
  800069:	50                   	push   %eax
  80006a:	68 66 2b 80 00       	push   $0x802b66
  80006f:	6a 09                	push   $0x9
  800071:	68 80 2b 80 00       	push   $0x802b80
...
exit(void)
{
  ...
  8000d2:	68 ac 2b 80 00       	push   $0x802bac
  8000d7:	50                   	push   %eax
  8000d8:	68 9e 2b 80 00       	push   $0x802b9e
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800108:	68 d8 2b 80 00       	push   $0x802bd8
  80010d:	50                   	push   %eax
  80010e:	68 9e 2b 80 00       	push   $0x802b9e
  ...
  80012f:	56                   	push   %esi
  800130:	50                   	push   %eax
  800131:	68 b4 2b 80 00       	push   $0x802bb4
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002cc:	0f be 80 df 2b 80 00 	movsbl 0x802bdf(%eax),%eax
  8002d3:	50                   	push   %eax
...
0080031b <vprintfmt>:
{
  ...
  800463:	50                   	push   %eax
  800464:	68 f7 2b 80 00       	push   $0x802bf7
  800469:	53                   	push   %ebx
  80046a:	56                   	push   %esi
  ...
  80048b:	b8 f0 2b 80 00       	mov    $0x802bf0,%eax
  ...
  800823:	bf 15 2d 80 00       	mov    $0x802d15,%edi
							putch(ch, putdat);
  ...
  80084f:	bf 4d 2d 80 00       	mov    $0x802d4d,%edi
							putch(ch, putdat);
...
spawn(const char *prog, const char **argv)
{
  ...
  801871:	68 a2 2b 80 00       	push   $0x802ba2
...
init_stack(envid_t child, const char **argv, uintptr_t *init_esp)
{
  ...
  801913:	68 a2 2b 80 00       	push   $0x802ba2
...
copy_shared_pages(envid_t child)
{
  ...
  801ca7:	68 a2 2b 80 00       	push   $0x802ba2
...
00801dee <spawnl>:
{
  ...
  801dfc:	68 a2 2b 80 00       	push   $0x802ba2
