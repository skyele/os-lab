...
umain(int argc, char **argv)
{
  ...
  800068:	c3                   	ret    
		panic("spawn(faultio) failed: %e", r);
  800069:	50                   	push   %eax
  80006a:	68 e6 2b 80 00       	push   $0x802be6
  80006f:	6a 09                	push   $0x9
  800071:	68 00 2c 80 00       	push   $0x802c00
...
libmain(int argc, char **argv)
{
  ...
  8000fd:	50                   	push   %eax
  8000fe:	68 14 2c 80 00       	push   $0x802c14
  800103:	e8 76 01 00 00       	call   80027e <cprintf>
	cprintf("before umain\n");
  800108:	c7 04 24 32 2c 80 00 	movl   $0x802c32,(%esp)
  ...
  80011d:	e8 11 ff ff ff       	call   800033 <umain>
	cprintf("after umain\n");
  800122:	c7 04 24 40 2c 80 00 	movl   $0x802c40,(%esp)
  ...
  800139:	50                   	push   %eax
  80013a:	68 4d 2c 80 00       	push   $0x802c4d
...
exit(void)
{
  ...
  800162:	68 78 2c 80 00       	push   $0x802c78
  800167:	50                   	push   %eax
  800168:	68 6c 2c 80 00       	push   $0x802c6c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800198:	68 a4 2c 80 00       	push   $0x802ca4
  80019d:	50                   	push   %eax
  80019e:	68 6c 2c 80 00       	push   $0x802c6c
  ...
  8001bf:	56                   	push   %esi
  8001c0:	50                   	push   %eax
  8001c1:	68 80 2c 80 00       	push   $0x802c80
  ...
  8001d2:	e8 56 00 00 00       	call   80022d <vcprintf>
	cprintf("\n");
  8001d7:	c7 04 24 30 2c 80 00 	movl   $0x802c30,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80035c:	0f be 80 ab 2c 80 00 	movsbl 0x802cab(%eax),%eax
  800363:	50                   	push   %eax
...
008003ab <vprintfmt>:
{
  ...
  8004f3:	50                   	push   %eax
  8004f4:	68 c3 2c 80 00       	push   $0x802cc3
  8004f9:	53                   	push   %ebx
  8004fa:	56                   	push   %esi
  ...
  80051b:	b8 bc 2c 80 00       	mov    $0x802cbc,%eax
  ...
  8008b3:	bf e1 2d 80 00       	mov    $0x802de1,%edi
							putch(ch, putdat);
  ...
  8008df:	bf 19 2e 80 00       	mov    $0x802e19,%edi
							putch(ch, putdat);
...
spawn(const char *prog, const char **argv)
{
  ...
  801901:	68 70 2c 80 00       	push   $0x802c70
...
init_stack(envid_t child, const char **argv, uintptr_t *init_esp)
{
  ...
  8019a2:	68 70 2c 80 00       	push   $0x802c70
...
copy_shared_pages(envid_t child)
{
  ...
  801d36:	68 70 2c 80 00       	push   $0x802c70
...
00801e7d <spawnl>:
{
  ...
  801e8b:	68 70 2c 80 00       	push   $0x802c70
